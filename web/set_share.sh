...
GREEN='\033[0;32m'
NC='\033[0m'
printf "${RED}WARNING${NC}: running this script will remove all share files in the ${RED}SHARE${NC} and ${RED}NATIVE${NC} directories!\n"
...
then
    ...
    cp -r src/share ../native/src/share
fi
