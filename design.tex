...
\begin{longtable}{ | p{3cm} | p{6cm} | p{6cm} | }
\hline
\textbf{Method Name} & \textbf{Method Output Type} & \textbf{Method Description} \\
\hline
getStartTime & Time object & This returns startTime \\
\hline
getEndTime & Time object & This returns endTime \\
\hline
getLocation & String & This returns location \\
\hline
getLocked & boolean & This returns locked \\
\hline
getDescription & String & This returns description \\
\hline
getName & String & This returns name \\
\hline
getNotifications & Notification object[] & This returns notifications \\
\hline
getParent & deadline event & This returns null if the object has no parent, otherwise it returns parent \\
\hline
setStartTime & void & This sets startTime to an input Time object \\
\hline
setEndTime & void & This sets endTime to an input Time object \\
\hline
setLocation & void & This sets location to an input location \\
\hline
setLocked & void & This sets locked to an input boolean \\
\hline
setDescription & void & This sets description to an input String \\
\hline
setName & void & This sets name to an input String \\
\hline
setNotifications & void & This sets notifications to an input notifications object[] \\
\hline
setParent & void & This sets the parent to an input deadline \\
\hline
\end{longtable}
\end{center}
...
\textbf{Method Name} & \textbf{Method Output Type} & \textbf{Method Description} \\
\hline
getCreatedEvents & Event[] & This returns createdEvents \\
\hline
getDeadline & Time object & This returns deadline \\
\hline
getTotalDuration & Number (in minutes) & This returns totalDuration \\
\hline
getminChildEventTime & Number (in minutes) & This returns minChildEventTime \\
\hline
getmaxChildEventTime & Number (in minutes) & This returns maxChildEventTime \\
\hline
getBreakTime & Number (in minutes) & This returns breakTime \\
\hline
getStartWorkTime & Time object & This returns startWorkTime \\
\hline
setCreatedEvents & void & This sets createdEvents to an input Event[] object \\
\hline
setDeadline & void & This sets deadline to an input Time object \\
\hline
setTotalDuration & void & This sets totalDuration to an input number \\
\hline
setminChildEventTime & void & This sets minChildEventTime to an input number \\
\hline
setmaxChildEventTime & void & This sets maxChildEventTime to an input number \\
\hline
setBreakTime & void & This sets breakTime to an input number \\
\hline
setStartWorkTime & void & This sets startWorkTime to an input Time object \\
\hline
addEvent & void & This adds an event to createdEvents \\
\hline
\end{longtable}
\end{center}
...
\textbf{Field Name} & \textbf{Field Type} & \textbf{Field Description} \\
\hline
frequency & String & A descriptive String which explains how often an event occurs \\
\hline
...
\textbf{Method Name} & \textbf{Method Output Type} & \textbf{Method Description} \\
\hline
getFrequency & String & This returns frequency \\
\hline
getExceptions & Time object[] & This returns exceptions \\
\hline
setFrequency & void & This sets frequency to a string \\
\hline
setExceptions & void & This makes Exceptions equal to an input Time object[] \\
\hline
mirrorEvent & void & This interprets frequency creates mirrors of the event \\
\hline
addException & void & This adds an input Time to exceptions \\
\hline
\end{longtable}
\end{center}
...
\textbf{Method Name} & \textbf{Method Output Type} & \textbf{Method Description} \\
\hline
getNotificationType & String & This returns notificationType \\
\hline
getTimeBefore & number (in minutes) & This returns timeBefore \\
\hline
setNotificationType & void & This sets notificationType to an input String \\
\hline
setTimeBefore & void & This sets timeBefore to an input number \\
\hline
\end{longtable}
\end{center}
