...
\hline
selectedTool & ToolEnum & Enermerated value that indicates which tool is currently selected. Used to determine behavior when user clicks on schedule.\\
\hline
...
\textbf{Attribute Name} & \textbf{Type} & \textbf{Description} \\
\hline
SelectedTool & ToolEnum & Enermerated value that indicates which tool is currently selected on the toolbar.\\
\hline
