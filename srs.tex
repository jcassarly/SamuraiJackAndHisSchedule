...
\begin{tabular}{ p{2cm} p{13cm} }
Standard Event &
The default event type. This cannot be moved by the autoscheduler by default.\\
\\
Location Event &
The event type which denotes where the user is within its duration.\\
\\
